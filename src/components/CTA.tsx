        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto text-center">
            ...
            >
              <Button
                size="lg"
                className="bg-primary text-primary-foreground font-semibold px-10 py-6 text-base rounded-xl hover:brightness-110 transition-all"
                asChild
              >
                <Link to="/register">
              ...
              <Button
                variant="ghost"
                size="lg"
                className="text-white border border-white/20 px-8 py-6 text-base rounded-xl hover:bg-white/10"
              >
                Schedule a Call
              </Button>
            </motion.div>
